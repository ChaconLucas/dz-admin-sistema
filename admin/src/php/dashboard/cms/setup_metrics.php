...
foreach ($statements as $statement) {
    ...
    if (mysqli_query($conexao, $statement)) {
        $messages[] = "✓ Statement executado com sucesso";
    } else {
        $success = false;
        $messages[] = "✗ Erro: " . mysqli_error($conexao);
    }
}
...
<head>
    <meta charset="UTF-8">
    <title>Setup Métricas - CMS D&Z</title>
    <style>
        body {
...
<body>
    <div class="container">
        <h1><?php echo $success ? '✓ Setup Concluído!' : '✗ Erro no Setup'; ?></h1>
        ...
        <p style="margin-top: 20px; color: #6b7280;">
            A tabela <strong>cms_home_metrics</strong> foi criada com sucesso e as métricas padrão foram inseridas.
        </p>
        <?php endif; ?>
        
        <a href="metrics.php" class="btn">Ir para Gerenciamento de Métricas</a>
    </div>
</body>
</html>
