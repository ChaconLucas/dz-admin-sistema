...
<head>
    ...
    <title>CMS - Métricas da Empresa | D&Z Admin</title>    <link rel="icon" type="image/x-icon" href="<?php echo BASE_URL; ?>admin/favicon.ico">    <link href="https://fonts.googleapis.com/icon?family=Material+Icons+Sharp" rel="stylesheet">
                ...
                <div style="padding: 2rem; background: var(--color-white); border-radius: var(--border-radius-2);">
                    <div style="text-align: center; padding: 3rem 2rem; color: var(--color-dark-variant);">
                        ...
                        <p style="line-height: 1.6; max-width: 600px; margin: 0 auto;">
                            Aqui você poderá gerenciar as métricas exibidas na home (ex: "+10.000 clientes", "98% satisfação"):
                        </p>
                        <ul style="text-align: left; max-width: 600px; margin: 1.5rem auto; line-height: 2;">
                            <li>Adicionar novas métricas</li>
                            <li>Definir título e valor (número ou texto)</li>
                            <li>Escolher ícone personalizado</li>
                            <li>Tipo: número, percentual ou texto</li>
                            <li>Reordenar métricas exibidas</li>
                            <li>Ativar/desativar sem excluir</li>
                        </ul>
                        <div style="margin-top: 2rem; padding: 1.5rem; background: var(--color-info-light); border-radius: var(--border-radius-1);">
                            <p style="color: var(--color-dark); margin: 0;">
                                <strong>Exemplos de métricas:</strong><br>
                                "+10.000 Clientes Satisfeitos" | "50+ Categorias" | "98% de Aprovação" | "Entrega em 3 Dias"
                            </p>
                        </div>
