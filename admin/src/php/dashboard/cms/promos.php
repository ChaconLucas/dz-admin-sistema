...
/*
TODO - IMPLEMENTAR:
- Tabela: cms_promotions (id, tipo, titulo, subtitulo, desconto, codigo_cupom, imagem_banner, data_inicio, data_fim, ativo, created_at, updated_at)
  * tipo: 'banner', 'cupom_destaque', 'flash_sale'
- Interface para gerenciar:
  * Banner de promoção (ex: "15% OFF na primeira compra")
  * Título e subtítulo da promoção
  * Percentual de desconto
  * Código de cupom associado
  * Upload de imagem (opcional)
  * Período de vigência (data início/fim)
  * Ativar/desativar promoção
- Integração com sistema de cupons existente
- Preview da seção no site
*/
?>
<!DOCTYPE html>
<html lang="pt-BR">
<head>
    ...
    <title>CMS - Promoções e Ofertas | D&Z Admin</title>    <link rel="icon" type="image/x-icon" href="<?php echo BASE_URL; ?>admin/favicon.ico">    <link href="https://fonts.googleapis.com/icon?family=Material+Icons+Sharp" rel="stylesheet">
        ...
        <main>
            ...
            <div class="insights">
                ...
                <div class="expenses" style="cursor: default;">
                    <span class="material-symbols-sharp">discount</span>
                    <div class="middle">
                        <div class="left">
            ...
            <div class="recent-orders" style="margin-top: 2rem;">
                ...
                <div style="padding: 2rem; background: var(--color-white); border-radius: var(--border-radius-2);">
                    <div style="text-align: center; padding: 3rem 2rem; color: var(--color-dark-variant);">
                        <span class="material-symbols-sharp" style="font-size: 4rem; color: var(--color-primary); display: block; margin-bottom: 1rem;">campaign</span>
                        <h3 style="margin-bottom: 0.8rem;">Funcionalidade em Desenvolvimento</h3>
                        <p style="line-height: 1.6; max-width: 600px; margin: 0 auto;">
                            Aqui você poderá gerenciar as promoções e ofertas exibidas na home (ex: banner "15% OFF"):
                        </p>
                        <ul style="text-align: left; max-width: 600px; margin: 1.5rem auto; line-height: 2;">
                            <li>Criar banner de promoção (título, subtítulo, porcentagem)</li>
                            <li>Vincular código de cupom</li>
                            <li>Upload de imagem do banner (opcional)</li>
                            <li>Definir período de vigência (data início e fim)</li>
                            <li>Ativar/desativar promoção</li>
                            <li>Integração com sistema de cupons</li>
                        </ul>
